...
const Drawer = ({ open, onToggle }) => {
  ...
  const handleLogout = () => {
    logout(); // ✅ Clear token, role, username
    ...
    <>
      ...
      >
        ...
        <nav className="flex-1 p-4 space-y-2">
          <NavItem icon={<HomeIcon size={20} />} label="Dashboard" open={open} onClick={() => navigate("/")} />
          <NavItem icon={<User size={20} />} label="Profile" open={open} onClick={() => navigate("/profile")} />
        </nav>
